    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_id', models.PositiveBigIntegerField(blank=True, error_messages={'unique': 'A user with that Telegram ID already exists.'}, null=True, unique=True, verbose_name='Telegram user ID')),
